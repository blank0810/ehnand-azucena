...
{/* TODO — Ehnand: why THIS order specifically? SambaNova and Groq first
     suggests you're optimizing for inference speed, with OpenAI as the
     reliable fallback. Was that the reasoning? Any cost numbers? What's
     the actual failure rate of the front of the chain? */}
...
{/* TODO — Ehnand: did you hit this? Any provider that consistently broke
     tool-calling or JSON mode? This would be the most valuable paragraph
     in the article — it's the thing people discover in production. */}
