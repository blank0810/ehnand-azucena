...
{/* TODO — Ehnand: what allocation policy did Initao actually use? Oldest-first?
     Did the municipality have a rule about penalties being paid before principal?
     This is a real business rule and I don't want to guess at it. */}
...
{/* TODO — Ehnand: this is the section that makes the article citable.
     What actually went wrong? Did you start with a balance column and migrate?
     Was there a reconciliation bug at the counter? A tariff change that
     retroactively broke old bills? The concrete failure is the whole point. */}
